...
public class LivreController {
	...
	@Autowired
	private AuteurService serviceA;
	...
	public HomeDTO findAll() {
        ...
        List<AuteurEntity> Auteurs = serviceA.findAll();
        List<EnumGenre> Genres = new ArrayList<EnumGenre>();
        
        for(LivreEntity e : service.findAll()) {
        	if(!Genres.contains(e.getGenre())){
        		Genres.add(e.getGenre());
        	};
        }
