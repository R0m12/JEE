...
import com.univlittoral.projetback.enums.GenresLivres;

@Entity
@Table(name="ulcotheque")
public class LivreEntity {
	...
	public GenresLivres getGenre() {
		return genre;
	}
	public void setGenre(GenresLivres genre) {
		this.genre = genre;
	}
